...
class PrizesControllerTest < ActionController::TestCase
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post :create, prize: { description: @prize.description, name: @prize.name, sponsor_id: @prize.sponsor_id }
    end
  ...
  test "should update prize" do
    patch :update, id: @prize, prize: { description: @prize.description, name: @prize.name, sponsor_id: @prize.sponsor_id }
    assert_redirected_to prize_path(assigns(:prize))
  end
